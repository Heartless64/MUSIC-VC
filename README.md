...
[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Heartless64/Music-VC)
...
```bash
$ git clone https://github.com/Heartless64/Music-VC
$ cd MusicPlayer
$ cp sample.env .env
